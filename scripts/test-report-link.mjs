...
test("a reply that cites the save_report line already has a link", () => {
	...
	assert.ok(replyHasReportLink("详见：📎 查看报告：https://reports.example.com/reports/6c45ac07-1f05-4e9d-bc71-b755c27268ca/8e7717a4-1d09-4761-9212-67d0ed946d8a.html"));
	assert.ok(replyHasReportLink("结果见 https://reports.example.com/reports/bfab8ebe-05c7/479d9538.html 如上。"));
});

test("a plain reply without any report link does not trip the detector", () => {
	assert.equal(replyHasReportLink("任务已完成，仍有 126 行未导入。"), false);
