			...
			<div className="mx-auto max-w-3xl space-y-5">
				...
				<Card title={editing ? "编辑资源" : "新增资源"} desc="链接类填 URL；文件类用下方按钮选择并上传。">
					...
					<div className="mt-5 flex flex-wrap items-center gap-3">
						{editing ? (
							<>
								<button type="button" disabled={busy} onClick={updateResource} className="rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700 disabled:opacity-50">
									保存修改
								</button>
							...
							<>
								<button type="button" disabled={busy} onClick={saveLink} className="rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700 disabled:opacity-50">
									保存为在线链接
								</button>
